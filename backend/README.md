...
## Project Structure
    ...
    ├── matchmade_apop_dev_102592  # Django project configurations
...
1. Clone this repo and `cd matchmade_apop_dev_102592`
...
2. Clone this repo and `cd matchmade_apop_dev_102592`
